package dev.sebastianjnuwu.bedwars.shop.parser;
...
import dev.sebastianjnuwu.bedwars.shop.model.ShopItemBuilder;
...
public class ShopConfigParser {
    ...
    public ShopConfigParser(final JavaPlugin plugin, final LangManager lang) {
        this.plugin = plugin;
        this.lang = lang;
    }
     ...
     */
    public ShopCategory loadCategory(String name, ConfigurationSection section) {
    ...
    private UpgradeConfig parseUpgradeConfig(Map<?, ?> map) {
        return ShopUpgradeParser.parseUpgradeConfig(map);
    }
