...
public class PlaceholderApiHook extends PlaceholderExpansion {
    ...
    public List<String> getPlaceholders() {
        return List.of(
                ...
                "mode_<modo>_players", "mode_<modo>_spectators", "mode_<modo>_total",
                "mode_<modo>_games", "mode_<modo>_games_playing", "mode_<modo>_games_waiting",
                "mode_<modo>_max_players",
