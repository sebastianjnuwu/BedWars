...
public class GeneratorRemoveCommand extends BaseCommand implements ArenaSubCommand {
    ...
    public void execute(final CommandSender sender, final @NotNull Arena arena, final @NotNull String @NotNull [] args) {
        ...
        if (args.length < 4) {
            player.sendMessage(this.lang.text(NamedTextColor.RED, "admin.arena.removegen_usage"));
            return;
        }
        ...
        player.sendMessage(this.lang.text(NamedTextColor.RED, "admin.arena.removegen_notfound", args[3]));
    }
    ...
    private void removeGenerator(final Player player, final Arena arena, final ArenaGenerator gen) {
        ...
        player.sendMessage(this.lang.text(NamedTextColor.GREEN, "admin.arena.removegen_success", genInfo));
    }
}
