...
public class TeamListCommand extends BaseCommand implements ArenaSubCommand {
    ...
    public void execute(final CommandSender sender, final @NotNull Arena arena, final @NotNull String @NotNull [] args) {
        ...
        if (teams.isEmpty()) {
            sender.sendMessage(this.lang.text(NamedTextColor.YELLOW, "admin.arena.teams_none"));
            return;
        }
        sender.sendMessage(this.lang.text(NamedTextColor.GOLD, "admin.arena.teams_header", arena.getName()));
        for (final ArenaTeam team : teams) {
            ...
            sender.sendMessage(this.lang.text(NamedTextColor.GRAY, "admin.arena.teams_entry",
